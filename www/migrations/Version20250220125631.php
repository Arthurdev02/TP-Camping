 ...
 */
final class Version20250220125631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, accomodations_id INT DEFAULT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, nbre_adults INT NOT NULL, nbre_childrens INT NOT NULL, INDEX IDX_E00CEDDE67B3B43D (users_id), UNIQUE INDEX UNIQ_E00CEDDE1E35121A (accomodations_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
